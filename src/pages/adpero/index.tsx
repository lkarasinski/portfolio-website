        ...
        <PageTransition>
            ...
            >
                <p>
                    ...
                    journey. Gives you ability to create polls to make decisions
                    together. Converts total cost of your journey to your
                    currency
                    <br />
                    <br />
                    ...
                    I&#39;ve settled with Next.js as the front-end framework,
                    and the app was created using Nx Monorepo. While coding this
                    project I&#39;ve overcame many challenges such as creating
                    and validating dynamic forms, handling javascript dates, and
